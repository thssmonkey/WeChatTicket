...
class CustomWeChatView(WeChatView):
    ...
    handlers = [
        HelpOrSubscribeHandler, UnbindOrUnsubscribeHandler, BindAccountHandler, BookEmptyHandler, CheckTicketHandler,
        BookWhatHandler, BookTicketHandler, RefundTicketHandler, ComputeExpHandler
    ]
